...
mediawiki_api_endpoint = 'https://kbtestwikibase.wikibase.cloud/w/api.php'

# SPARQL endpoint
wikibase_sparql_endpoint = 'https://kbtestwikibase.wikibase.cloud/query/'
# Name of the Wikibase instance
wikibase_name = 'KBTestWikibase.cloud'

# URL of the main page of the Wikibase instance
wikibase_main_page = 'https://kbtestwikibase.wikibase.cloud/wiki/Main_Page'
...
# https://kbtestwikibase.wikibase.cloud/wiki/Special:AllPages?from=&to=&namespace=120
...
import re
q_re = re.compile(r'(<?https?://kbtestwikibase.wikibase.cloud/(entity|wiki)/)?(Q[0-9]+)>?')
q_re_group_id = 3
p_re = re.compile(r'(<?https?://kbtestwikibase.wikibase.cloud/(entity/|wiki/Property:))?(P[0-9]+)>?')
p_re_group_id = 3

# Identifier space and schema space exposed to OpenRefine.
# This should match the IRI prefixes used in RDF serialization. For instance: https://kbtestwikibase.wikibase.cloud/wiki/Special:EntityData/Q10.rdf 
...
identifier_space = 'https://kbtestwikibase.wikibase.cloud/entity/'
schema_space = 'https://kbtestwikibase.wikibase.cloud/prop/direct/'
...
qid_url_pattern = 'https://kbtestwikibase.wikibase.cloud/wiki/Item:{{id}}'
...
service_name = 'KBTestWikibase.cloud recon service'
...
fallback_image_alt = 'KBTestwikibase.cloud logo'
...
# https://kbtestwikibase.wikibase.cloud/wiki/Property:P3
type_property_path = 'P3' 
...
# https://kbtestwikibase.wikibase.cloud/wiki/Property:P2
